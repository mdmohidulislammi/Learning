    ...
    return (
        <div className="flex items-center justify-between  font-sans rounded-2xl">
          ...
          <div className="flex items-center gap-6">
             <img className="w-10 cursor-pointer" src={searchIcon} alt="search-icon" />
             <div className="group relative">
              <img src={profileIcon} className="w-10 cursor-pointer" alt="profile" />
              <div className="group-hover:block hidden absolute dropdown-menu right-0 pt-4">
                <div className="flex flex-col gap-2 2-36 py-2 px-4 bg-slate-100 text-black">
                  <p className="cursor-pointer hover:text-gray-500 font-semibold">Profile</p>
                  <p className="cursor-pointer hover:text-gray-500 font-semibold">Orders</p>
                  <p className="cursor-pointer hover:text-gray-500 font-semibold">Cart</p>
                  <p className="cursor-pointer hover:text-gray-500 font-semibold">Logout</p>                  
                </div>               
              </div>
             </div>
              ...
              <div
                ...
                <ul className="flex flex-col gap-6 px-6 text-black font-semibold">
                  ...
                  <NavLink to="/categories" onClick={() => setVisible(false)} className="hover:text-blue-500">ABOUT</NavLink>
                  <NavLink to="/categories" onClick={() => setVisible(false)} className="hover:text-blue-500">CONTACT</NavLink>
